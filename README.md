...
1. [If training with high res textures, otherwise skip steps 1&2] Just create a function to downsize your input by a factor of N (which you can choose, we chose 4)
2. Resize (aka stretch) the downsized image back to its original size (this destroys details and makes it blurry to resemble an outdated texture)
