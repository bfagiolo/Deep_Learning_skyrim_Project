...
NOTE: The instructions on this page are pretty much just for training your own **diffusion** model. Training the GAN is pretty similar, and you should take the GAN outputs and run them through the Diffusion after.
